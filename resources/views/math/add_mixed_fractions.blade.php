...
@section('content')
    <div class="container mt-5">
        <div class="row justify-content-center">
            <div class="col-md-8">
                <div class="card">
                    <div class="card-body">
                        <h5>Addition of Mixed Fractions</h5>
    ...
    <script>
        ...
        // Function to add mixed fractions and simplify result
        function addMixedFractions(whole1, numerator1, denominator1, whole2, numerator2, denominator2) {
            ...
            // Add the numerators
            const sumNumerator = improper1 * denominator2 + improper2 * denominator1;

            // Calculate the whole number, numerator, and denominator
            const sumWhole = Math.floor(sumNumerator / commonDenominator);
            const sumNumeratorRemainder = sumNumerator % commonDenominator;

            return {
                whole: sumWhole,
                numerator: sumNumeratorRemainder,
                denominator: commonDenominator
            };
        }


        // Calculate addition on button click
        document.getElementById('calculate-button').addEventListener('click', function() {
            ...
            // Add each subsequent mixed fraction to the initial one
            for (let i = 1; i < wholes.length; i++) {
                const whole = parseInt(wholes[i].value);
                const numerator = parseInt(numerators[i].value);
                const denominator = parseInt(denominators[i].value);
                const result = addMixedFractions(
